    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('inquilinos.update', $inquilino->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="correo_electronico" class="form-control" id="correo_electronico" name="correo_electronico" value="{{ old('correo_electronico', $usuario->correo_electronico) }}" required>
